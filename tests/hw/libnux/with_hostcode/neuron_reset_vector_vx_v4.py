...
from dlens_vx_v4.hal import Barrier, NeuronConfig, SpikeCounterReset
...
from dlens_vx_v4 import hal, halco
...
class LibnuxNeuronResetVectorTestVx(unittest.TestCase):
    ...
    def test_neuron_reset(self):
        ...
        program = join(TEST_BINARY_PATH, "neuron_reset_vector-ppu_vx_v4.bin")
