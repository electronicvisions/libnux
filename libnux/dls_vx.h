...
static constexpr libnux::omnibus_address_t sram_top_base_address = 0x02800000;
static constexpr libnux::omnibus_address_t sram_bot_base_address = 0x03800000;

/* Address of synram */
static constexpr libnux::omnibus_address_t synram_top_base_address = sram_top_base_address | (1 << 22);
static constexpr libnux::omnibus_address_t synram_bottom_base_address = sram_bot_base_address | (1 << 22);
