...
/**
 * Vector-unit type with 16-bit signed elements and fractional saturating arithmetic.
 */
struct VectorFracSat16
{
	typedef __vector int16_t Data;
	Data data;
	 ...
	 */
	ATTRIB_ALWAYS_INLINE VectorFracSat16();

	/**
	 * Construct vector by broadcasting given element value.
	 * @param value Element value to broadcast
	 */
	ATTRIB_ALWAYS_INLINE VectorFracSat16(Element value);

	/**
	 * Construct vector from data.
	 * @param value Data to use
	 */
	ATTRIB_ALWAYS_INLINE VectorFracSat16(Data const& value);

	/**
	 * Copy constructor.
	 * @param other Instance to copy from
	 */
	ATTRIB_ALWAYS_INLINE VectorFracSat16(VectorFracSat16 const& other);
	 ...
	 */
	ATTRIB_ALWAYS_INLINE VectorFracSat16& operator=(VectorFracSat16 const& other);
	 ...
	 */
	ATTRIB_ALWAYS_INLINE bool operator==(VectorFracSat16 const& other) const;
	 ...
	 */
	ATTRIB_ALWAYS_INLINE VectorFracSat16 operator-() const;
	 ...
	 */
	ATTRIB_ALWAYS_INLINE VectorFracSat16& operator+=(VectorFracSat16 const& rhs);
	 ...
	 * @return Reference to altered instance
	 */
	ATTRIB_ALWAYS_INLINE VectorFracSat16& operator<<=(int num_bits);
	 ...
	 */
	ATTRIB_ALWAYS_INLINE VectorFracSat16 operator+(VectorFracSat16 const& rhs) const;
	 ...
	 * @return Reference to altered instance
	 */
	ATTRIB_ALWAYS_INLINE VectorFracSat16 operator<<(int num_bits) const;
	 ...
	 */
	ATTRIB_ALWAYS_INLINE VectorMod16 convert_contiguous() const;

	/**
	 * Convert signed vector with fractional arithmetic to unsigned vector with modulo arithmetic.
	 * The conversion is not contiguous and equivalent to a static_cast of the element types.
	 */
	ATTRIB_ALWAYS_INLINE explicit operator VectorMod16() const;
};

/**
 * Add 16-bit signed vector with fractional saturating arithmetics to broadcasted 16-bit signed
 * element value.
 * @param lhs VectorFracSat16::Element value
 * @param rhs Vector value
 * @return Resulting vector
 */
ATTRIB_ALWAYS_INLINE VectorFracSat16
operator+(VectorFracSat16::Element lhs, VectorFracSat16 const& rhs);
...
#include "libnux/vx/vector_frac_sat_16.tcc"
